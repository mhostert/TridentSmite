...
// constants
#define GeV2_to_cm2 3.89379372e-28 // hbar c = 197.3269804e-16 GeV.cm
#define Gf 1.16637876e-5 // Fermi constant (GeV^-2)
#define alphaQED  1.0/137.03599908421 // Fine structure constant at q2 -> 0

#define sw2 0.23857 // sin of weak angle at q2 -> 0
...
// Masses
#define m_e 0.5109989500015e-3 // GeV
#define m_mu 0.1134289257 // GeV
#define m_tau 1.77682 // GeV

#define m_pi0 0.13497 // GeV
#define m_pic 0.13957 // GeV

#define m_proton 0.93827208816 // GeV
#define m_neutron 0.93956542052 // GeV
#define m_AVG (m_proton+m_neutron)/2. // GeV

#define mW 80.37912 // GeV
#define mZ 91.187621 // GeV
...
///////////////////////////////////
// variables for the integration algorithms
#define NCOMP 		1
...
/////////////////////////////////////////////////////
// RANDOM NUMBER GENERATORS -- these are not used by vegas 
...
/////////////////////////////////////////////////////
// Interpolate flux
long double flux_interpolate( std::vector<long double> &xData, std::vector<long double> &yData, long double x, long double fill_value );
