...
///////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////////////////////
  // CONVOLVING THE FLUX
  myMC->xphys[9] *= (myMC->Emax - myMC->Emin); // jacobian of energy integration
  myMC->xphys[9] *= flux_interpolate(myMC->E_flux,myMC->nu_flux,Enu,0.0); // fill zero outside range
  ///////////////////////////////////////////////////////////////////////////////////
  // final integrand
  // ff[0] = myMC->xphys[9];
  ff[0] =  (myMC->Emax - myMC->Emin)*flux_interpolate(myMC->E_flux,myMC->nu_flux,Enu,0.0);
